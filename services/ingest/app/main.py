...
# matches services/fit and services/search, and the convention the Worker's
# getUpstreamHealth already uses for the solver origin. See infra/README.md. Crawl/extract
